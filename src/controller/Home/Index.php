...
class Index extends Controller
{
    ...
    {
//        Log::write("test");
//        $res = Db::collection('user')->add(['nickname'=>'huaerjie']);
        Session::set('user', ['nickname'=>'huaerjie']);
        $param['id'] = $this->request->get('id');
        $test = Db::redis()->get('test');
        $param['test'] = $test;
//        $info = Db::table('admin_user')->where(['id'=>1])->find();
//        $info = ['nickname'=>'huaerjie'];
        $this->jsonReturn($param);
