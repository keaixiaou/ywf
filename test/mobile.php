    ...
    public static function sanitize($mobile)
    {
        ...
        if(Mobile::isDomesticMobile($mobile)) {
            ...
            if (!Mobile::isMobile($mobile)) {
                throw new Exception('手机号码，咋就不对呢');
            }
        }
...
echo json_encode($tradeFans);die;

$agent = 'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_1 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E304 MicroMessenger/6.5.8 NetType/WIFI Language/zh_CN';
$res = Mobile::ismymobile($agent);
var_dump($res);
die;
var_dump(Mobile::sanitize('86-18167158602'));
var_dump(Mobile::sanitize('83-18167158602'));